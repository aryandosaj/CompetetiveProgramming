...
void solve(){
	...
	while(i < (ll)s.length()){
		if((i+1)<(ll)s.length()&&s[i] == 'S' && s[i + 1] == 'S' ){
			ll j;
			for(j=i+2;j<(ll)s.length();j++) if(s[j] == 'N') break;
		...
		if((i+2)<(ll)s.length()&&s[i] == 'S' && s[i + 1] == 'N' && s[i + 2] == 'S'){
		...
		if((i+2)<(ll)s.length()&&s[i] == 'S' && s[i + 1] == 'N' && s[i + 2] == 'T'){
		...
		if((i+2)<(ll)s.length()&&s[i] == 'S' && s[i + 1] == 'N' && s[i + 2] == 'N'){
		...
		if((i+3)<(ll)s.length()&&s[i] == 'T' && s[i + 1] == 'S' && s[i + 2] == 'S' && s[i + 3] == 'S'){
		...
		if((i+3)<(ll)s.length()&&s[i] == 'T' && s[i + 1] == 'S' && s[i + 2] == 'S' && s[i + 3] == 'T'){
		...
		if((i+3)<(ll)s.length()&&s[i] == 'T' && s[i + 1] == 'S' && s[i + 2] == 'S' && s[i + 3] == 'N'){
		...
		if((i+3)<(ll)s.length()&&s[i] == 'T' && s[i + 1] == 'S' && s[i + 2] == 'T' && s[i + 3] == 'S'){
		...
		if((i+3)<(ll)s.length()&&s[i] == 'T' && s[i + 1] == 'N' && s[i + 2] == 'S' && s[i + 3] == 'T'){
